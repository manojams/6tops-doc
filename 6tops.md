...
The complete dial-up process is shown as follows:
        ...
        [1] 540
        openaia@6tops:~$ 
        openaia@6tops:~$ sudo: unable to resolve host fakemachine: Temporary failure in name resolution
...
Check the updated config of ppp using ifconfig
        ...
        sudo: unable to resolve host fakemachine: Temporary failure in name resolution
